        ...
        <div className="grid grid-cols-1  md:grid-cols-[400px_1fr] lg:px-5">
          ...
          <div className="order-2 md:order-1">
            <form action="#" className="flex items-center gap-1.5">
              <input
                className="px-[12px] py-[8px] border border-[#e2e2e2;] focus:border-black/50 focus:outline-dotted transition-colors bg-white"
                type="search"
                name="search"
                id="search"
              ...
              <button
                type="submit"
                className="px-2 py-[12px] bg-[#0084d6;] text-white"
              >
                <FaGreaterThan />
              </button>
            </form>
          ...
          <div className="order-1 md:order-2 p-3 md:px-5 md:py-5 lg:px-10 lg:py-30">
            <div>
              <div className="bg-white px-6 py-15">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <select className="block  p-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-blue-500">
            ...
            <div className="flex items-center justify-start gap-1.5">
              <button className="px-4.5 py-2.5 bg-black text-white hover:bg-white hover:text-black border">
                1
              </button>
              <button className="px-4.5 py-2.5 text-black hover:bg-black hover:text-white border">
                2
              </button>
              <button className="px-3 py-3.5 text-black hover:bg-black hover:text-white border">
