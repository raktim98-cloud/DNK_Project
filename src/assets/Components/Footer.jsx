        ...
        <div className="container mx-auto">
            <div>
                <div className="py-10 border-t border-[#E5E5E5] border-b">
                    <h2 className="text-[1.625rem] font-bold leading-[1.3em]">SALE UP TO 70% OFF FOR ALL CLOTHES & FASHION ITEMS, ON ALL BRANDS.</h2>
                </div>
                <div className="grid grid-cols-4 gap-4 pb-12 items-center justify-center pt-12 ">
                    <div>
                ...
                <div className="py-10 border-t border-[#E5E5E5] border-b flex items-center justify-between px-10">
